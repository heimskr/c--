...
struct_list: struct_list type CMMTOK_IDENT ";" { $$ = $1->adopt($3->adopt($2)); D($4); }
           ...
           | struct_list "static" type CMMTOK_IDENT ";" { $$ = $1->adopt($4->adopt($3)); $4->attributes.insert("static"); D($2, $5); }
           | struct_list "static" type CMMTOK_IDENT "=" expr ";" { $$ = $1->adopt($4->adopt({$3, $6})); $4->attributes.insert("static"); D($2, $5, $7); }
